...
public class MinHeapImpl2Test {
  public static void main(String[] args) {
    MinHeapImpl2 minheap = new MinHeapImpl2();
    minheap.insert(5);
    minheap.printBackingArray();
    minheap.insert(6);
    minheap.printBackingArray();
    minheap.insert(4);
    minheap.printBackingArray();
    ...
    while (!minheap.isEmpty()) {
      System.out.println(String.valueOf(minheap.removeMin()));
    }
  }

  public static class MinHeapImpl2 {
    private int len = 0;
